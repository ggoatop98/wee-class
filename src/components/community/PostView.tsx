...
import { doc, onSnapshot, collection, addDoc, Timestamp, query, orderBy, deleteDoc, updateDoc, increment } from 'firebase/firestore';
...
export default function PostView({ postId }: PostViewProps) {
    ...
    const handleDeleteComment = async (commentId: string) => {
        try {
            ...
            // Atomically decrement the comment count
            await updateDoc(doc(db, 'posts', postId), {
                commentCount: increment(-1)
            });
    ...
    return (
        <>
            ...
            {/* Comments Section */}
            <div className="mt-8">
                <h3 className="text-lg font-semibold mb-4">댓글 ({post.commentCount || 0})</h3>
