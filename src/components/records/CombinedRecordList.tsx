  ...
  return (
    <div className="rounded-lg border bg-card">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="w-[100px] text-base">날짜</TableHead>
            <TableHead className="w-[80px] text-base">시간</TableHead>
            <TableHead className="w-[240px] text-base">내담자</TableHead>
